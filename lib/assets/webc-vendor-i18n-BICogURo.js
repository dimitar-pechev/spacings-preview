import { r as j } from "./webc-vendor-CvrN3tmw.js";
const $e = (r, e, t, s) => {
  const i = [t, {
    code: e,
    ...s || {}
  ...
  D(i[0]) && (i[0] = `react-i18next:: ${i[0]}`), r?.services?.logger?.warn ? r.services.logger.warn(...i) : console?.warn && console.warn(...i);
}, re = {}, Z = (r, e, t, s) => {
  D(t) && re[t] || (D(t) && (re[t] = /* @__PURE__ */ new Date()), $e(r, e, t, s));
}, Oe = (r, e) => () => {
  if (r.isInitialized)
    e();
  else {
  ...
  r.loadNamespaces(e, Oe(r, t));
}, ae = (r, e, t, s) => {
  if (D(t) && (t = [t]), r.options.preload && r.options.preload.indexOf(e) > -1) return X(r, t, s);
  t.forEach((i) => {
    r.options.ns.indexOf(i) < 0 && r.options.ns.push(i);
  }), r.loadLanguages(e, Oe(r, s));
}, Pe = (r, e, t = {}) => !e.languages || !e.languages.length ? (Z(e, "NO_LANGUAGES", "i18n.languages were undefined or empty", {
  languages: e.languages
}), !0) : e.hasLoadedNamespace(r, {
  lng: t.lng,
  precheck: (s, i) => {
    if (t.bindI18n?.indexOf("languageChanging") > -1 && s.services.backendConnector.backend && s.isLanguageChangingTo && !i(s.isLanguageChangingTo, r)) return !1;
  }
}), D = (r) => typeof r == "string", ke = (r) => typeof r == "object" && r !== null, Ee = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, Fe = {
  "&amp;": "&",
  "&#38;": "&",
  "&lt;": "<",
  "&#60;": "<",
  ...
  "&#x2F;": "/",
  "&#47;": "/"
}, je = (r) => Fe[r], Ie = (r) => r.replace(Ee, je);
let q = {
...
const Me = (r, e) => {
...
}, we = (r, e, t, s) => r.getFixedT(e, t, s), He = (r, e, t, s) => j.useCallback(we(r, e, t, s), [r, e, t, s]), ft = (r, e = {}) => {
  const {
    i18n: t
  } = e, {
    i18n: s,
    defaultNS: i
  } = j.useContext(Ae) || {}, n = t || s || Ke();
  if (n && !n.reportNamespaces && (n.reportNamespaces = new Ue()), !n) {
    Z(n, "NO_I18NEXT_INSTANCE", "useTranslation: You will need to pass in an i18next instance by using initReactI18next");
    const x = (O, L) => D(L) ? L : ke(L) && D(L.defaultValue) ? L.defaultValue : Array.isArray(O) ? O[O.length - 1] : O, b = [x, {}, !1];
    return b.t = x, b.i18n = {}, b.ready = !1, b;
  }
  n.options.react?.wait && Z(n, "DEPRECATED_OPTION", "useTranslation: It seems you are still using the old wait option, you may migrate to the new useSuspense behaviour.");
  const a = {
    ...De(),
    ...n.options.react,
    ...e
  ...
  let l = i || n.options?.defaultNS;
  l = D(l) ? [l] : l || ["translation"], n.reportNamespaces.addUsedNamespaces?.(l);
  const f = (n.isInitialized || n.initializedStoreOnce) && l.every((x) => Pe(x, n, a)), c = He(n, e.lng || null, a.nsMode === "fallback" ? l : l[0], u), p = () => c, d = () => we(n, e.lng || null, a.nsMode === "fallback" ? l : l[0], u), [h, y] = j.useState(p);
  let S = l.join();
  e.lng && (S = `${e.lng}${S}`);
  const C = Me(S), m = j.useRef(!0);
  j.useEffect(() => {
    const {
      bindI18n: x,
      bindI18nStore: b
    } = a;
    m.current = !0, !f && !o && (e.lng ? ae(n, e.lng, l, () => {
      m.current && y(d);
    }) : X(n, l, () => {
      m.current && y(d);
    })), f && C && C !== S && m.current && y(d);
    const O = () => {
      m.current && y(d);
    };
    return x && n?.on(x, O), b && n?.store.on(b, O), () => {
      m.current = !1, n && x?.split(" ").forEach((L) => n.off(L, O)), b && n && b.split(" ").forEach((L) => n.store.off(L, O));
    };
  }, [n, S]), j.useEffect(() => {
    m.current && f && y(p);
  }, [n, u, f]);
  const N = [h, n, f];
  if (N.t = h, N.i18n = n, N.ready = f, f || !f && !o) return N;
  throw new Promise((x) => {
    e.lng ? ae(n, e.lng, l, () => x()) : X(n, l, () => x());
  });
}, g = (r) => typeof r == "string", U = () => {
  let r, e;
  const t = new Promise((s, i) => {
    r = s, e = i;
  });
  return t.resolve = r, t.reject = e, t;
}, oe = (r) => r == null ? "" : "" + r, ze = (r, e, t) => {
  r.forEach((s) => {
    e[s] && (t[s] = e[s]);
  });
}, Be = /###/g, le = (r) => r && r.indexOf("###") > -1 ? r.replace(Be, ".") : r, ue = (r) => !r || g(r), M = (r, e, t) => {
  ...
  for (; o.obj === void 0 && a.length; )
    n = `${a[a.length - 1]}.${n}`, a = a.slice(0, a.length - 1), o = M(r, a, Object), o?.obj && typeof o.obj[`${o.k}.${n}`] < "u" && (o.obj = void 0);
  o.obj[`${o.k}.${n}`] = t;
}, Je = (r, e, t, s) => {
  const {
    obj: i,
  ...
  for (const s in e)
    s !== "__proto__" && s !== "constructor" && (s in r ? g(r[s]) || r[s] instanceof String || g(e[s]) || e[s] instanceof String ? t && (r[s] = e[s]) : Ce(r[s], e[s], t) : r[s] = e[s]);
  return r;
}, V = (r) => r.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&");
var _e = {
  "&": "&amp;",
...
const Ge = (r) => g(r) ? r.replace(/[&<>"'\/]/g, (e) => _e[e]) : r;
class Qe {
  constructor(e) {
...
const Ye = [" ", ",", "?", "!", ";"], Ze = new Qe(20), Xe = (r, e, t) => {
  e = e || "", t = t || "";
  const s = Ye.filter((a) => e.indexOf(a) < 0 && t.indexOf(a) < 0);
  if (s.length === 0) return !0;
  const i = Ze.getRegExp(`(${s.map((a) => a === "?" ? "\\?" : a).join("|")})`);
  let n = !i.test(r);
  if (!n) {
    const a = r.indexOf(t);
...
class ce extends Q {
  ...
  getResource(e, t, s, i = {}) {
    ...
    const u = W(this.data, o);
    return !u && !t && !s && e.indexOf(".") > -1 && (e = o[0], t = o[1], s = o.slice(2).join(".")), u || !a || !g(s) ? u : ee(this.data?.[e]?.[t], s, n);
  }
  addResource(e, t, s, i, n = {
    ...
    let o = [e, t];
    s && (o = o.concat(a ? s.split(a) : s)), e.indexOf(".") > -1 && (o = e.split("."), i = t, t = o[1]), this.addNamespaces(t), fe(this.data, o, i), n.silent || this.emit("added", e, t, s, i);
  }
  ...
  addResourceBundle(e, t, s, i, n, a = {
    ...
    let u = W(this.data, o) || {};
    a.skipCopy || (s = JSON.parse(JSON.stringify(s))), i ? Ce(u, s, n) : u = {
      ...u,
      ...s
    }, fe(this.data, o, u), a.silent || this.emit("added", e, t, s);
  }
...
const he = {}, de = (r) => !g(r) && typeof r != "boolean" && typeof r != "number";
class G extends Q {
  constructor(e, t = {}) {
  ...
  translate(e, t, s) {
    ...
    let h = d?.res;
    const y = d?.usedKey || o, S = d?.exactUsedKey || o, C = ["[object Number]", "[object Function]", "[object RegExp]"], m = i.joinArrays !== void 0 ? i.joinArrays : this.options.joinArrays, N = !this.i18nFormat || this.i18nFormat.handleAsObject, x = i.count !== void 0 && !g(i.count), b = G.hasDefaultValue(i), O = x ? this.pluralResolver.getSuffix(c, i.count, i) : "", L = i.ordinal && x ? this.pluralResolver.getSuffix(c, i.count, {
      ordinal: !1
    }) : "", te = x && !i.ordinal && i.count === 0, I = te && i[`defaultValue${this.options.pluralSeparator}zero`] || i[`defaultValue${O}`] || i[`defaultValue${L}`] || i.defaultValue;
    let $ = h;
    N && !h && b && ($ = I);
    const ve = de($), Re = Object.prototype.toString.apply($);
    if (N && $ && ve && C.indexOf(Re) < 0 && !(g(m) && Array.isArray($))) {
      if (!i.returnObjects && !this.options.returnObjects) {
        this.options.returnedObjectHandler || this.logger.warn("accessing an object - but returnObjects options is not enabled!");
        const P = this.options.returnedObjectHandler ? this.options.returnedObjectHandler(y, $, {
          ...i,
          ns: u
        }) : `key '${o} (${this.language})' returned an object instead of string.`;
        return n ? (d.res = P, d.usedParams = this.getUsedParamsDetails(i), d) : P;
      }
      if (a) {
        const P = Array.isArray($), R = P ? [] : {}, se = P ? S : y;
        for (const k in $)
          if (Object.prototype.hasOwnProperty.call($, k)) {
            const F = `${se}${a}${k}`;
            b && !h ? R[k] = this.translate(F, {
              ...i,
              defaultValue: de(I) ? I[k] : void 0,
              joinArrays: !1,
              ns: u
            }) : R[k] = this.translate(F, {
              ...i,
              joinArrays: !1,
              ns: u
            }), R[k] === F && (R[k] = $[k]);
    ...
    } else if (N && g(m) && Array.isArray(h))
      h = h.join(m), h && (h = this.extendTranslation(h, e, i, s));
    else {
      let P = !1, R = !1;
      !this.isValidLookup(h) && b && (P = !0, h = I), this.isValidLookup(h) || (R = !0, h = o);
      const k = (i.missingKeyNoValueFallbackToKey || this.options.missingKeyNoValueFallbackToKey) && R ? void 0 : h, F = b && I !== h && this.options.updateMissing;
      if (R || P || F) {
        if (this.logger.log(F ? "updateKey" : "missingKey", c, l, o, F ? I : h), a) {
        ...
        const ie = (v, T, A) => {
          const ne = b && A !== h ? A : k;
          this.options.missingKeyHandler ? this.options.missingKeyHandler(v, l, T, ne, F, i) : this.backendConnector?.saveMissing && this.backendConnector.saveMissing(v, l, T, ne, F, i), this.emit("missingKey", v, l, T, h);
        };
        this.options.saveMissing && (this.options.saveMissingPlurals && x ? K.forEach((v) => {
          const T = this.pluralResolver.getSuffixes(v, i);
          te && i[`defaultValue${this.options.pluralSeparator}zero`] && T.indexOf(`${this.options.pluralSeparator}zero`) < 0 && T.push(`${this.options.pluralSeparator}zero`), T.forEach((A) => {
            ie([v], o + A, i[`defaultValue${A}`] || I);
          });
        }) : ie(K, o, I));
      }
      h = this.extendTranslation(h, e, i, d, s), R && h === o && this.options.appendNamespaceToMissingKey && (h = `${l}${f}${o}`), (R || P) && this.options.parseMissingKeyHandler && (h = this.options.parseMissingKeyHandler(this.options.appendNamespaceToMissingKey ? `${l}${f}${o}` : o, P ? h : void 0, i));
    }
  ...
  extendTranslation(e, t, s, i, n) {
    if (this.i18nFormat?.parse)
      ...
      const u = g(e) && (s?.interpolation?.skipOnVariables !== void 0 ? s.interpolation.skipOnVariables : this.options.interpolation.skipOnVariables);
      let l;
      if (u) {
      ...
      if (this.options.interpolation.defaultVariables && (f = {
        ...this.options.interpolation.defaultVariables,
        ...f
      }), e = this.interpolator.interpolate(e, f, s.lng || this.language || i.usedLng, s), u) {
    ...
    return e != null && o?.length && s.applyPostProcessor !== !1 && (e = Ne.handle(o, e, t, this.options && this.options.postProcessPassResolved ? {
      i18nResolved: {
        ...i,
  ...
  resolve(e, t = {}) {
    ...
    return g(e) && (e = [e]), e.forEach((u) => {
      ...
      const p = t.count !== void 0 && !g(t.count), d = p && !t.ordinal && t.count === 0, h = t.context !== void 0 && (g(t.context) || typeof t.context == "number") && t.context !== "", y = t.lngs ? t.lngs : this.languageUtils.toResolveHierarchy(t.lng || this.language, t.fallbackLng);
      c.forEach((S) => {
        this.isValidLookup(s) || (o = S, !he[`${y[0]}-${S}`] && this.utils?.hasLoadedNamespace && !this.utils?.hasLoadedNamespace(o) && (he[`${y[0]}-${S}`] = !0, this.logger.warn(`key "${i}" for languages "${y.join(", ")}" won't get resolved as namespace "${o}" was not yet loaded`, "This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!")), y.forEach((C) => {
          if (this.isValidLookup(s)) return;
          a = C;
          const m = [f];
          if (this.i18nFormat?.addLookupKeys)
            this.i18nFormat.addLookupKeys(m, f, C, S, t);
          else {
            let x;
            p && (x = this.pluralResolver.getSuffix(C, t.count, t));
            const b = `${this.options.pluralSeparator}zero`, O = `${this.options.pluralSeparator}ordinal${this.options.pluralSeparator}`;
            if (p && (m.push(f + x), t.ordinal && x.indexOf(O) === 0 && m.push(f + x.replace(O, this.options.pluralSeparator)), d && m.push(f + b)), h) {
              const L = `${f}${this.options.contextSeparator}${t.context}`;
              m.push(L), p && (m.push(L + x), t.ordinal && x.indexOf(O) === 0 && m.push(L + x.replace(O, this.options.pluralSeparator)), d && m.push(L + b));
            }
          }
          let N;
          for (; N = m.pop(); )
            this.isValidLookup(s) || (n = N, s = this.getResource(C, S, N, t));
        }));
      });
    }), {
      res: s,
...
class et {
  ...
  getRule(e, t = {}) {
    const s = H(e === "dev" ? "en" : e), i = t.ordinal ? "ordinal" : "cardinal", n = JSON.stringify({
      cleanedCode: s,
      type: i
    });
  ...
  getSuffixes(e, t = {}) {
    let s = this.getRule(e, t);
    return s || (s = this.getRule("dev", t)), s ? s.resolvedOptions().pluralCategories.sort((i, n) => pe[i] - pe[n]).map((i) => `${this.options.prepend}${t.ordinal ? `ordinal${this.options.prepend}` : ""}${i}`) : [];
  }
  getSuffix(e, t, s = {}) {
...
const xe = (r, e, t, s = ".", i = !0) => {
  let n = We(r, e, t);
  return !n && i && g(t) && (n = ee(r, t, s), n === void 0 && (n = ee(e, t, s))), n;
}, Y = (r) => r.replace(/\$/g, "$$$$");
class tt {
  constructor(e = {}) {
    this.logger = E.create("interpolator"), this.options = e, this.format = e?.interpolation?.format || ((t) => t), this.init(e);
  }
  init(e = {}) {
  ...
  interpolate(e, t, s, i) {
    ...
    const u = this.options && this.options.interpolation && this.options.interpolation.defaultVariables || {}, l = (d) => {
      if (d.indexOf(this.formatSeparator) < 0) {
        const C = xe(t, u, d, this.options.keySeparator, this.options.ignoreJSONStructure);
      ...
      const h = d.split(this.formatSeparator), y = h.shift().trim(), S = h.join(this.formatSeparator).trim();
      return this.format(xe(t, u, y, this.options.keySeparator, this.options.ignoreJSONStructure), S, s, {
        ...i,
        ...t,
        interpolationkey: y
      });
    ...
    return [{
      ...
      for (o = 0; n = d.regex.exec(e); ) {
        ...
        else !g(a) && !this.useRawValueToEscape && (a = oe(a));
        const y = d.safeValue(a);
        if (e = e.replace(n[0], y), c ? (d.regex.lastIndex += a.length, d.regex.lastIndex -= n[0].length) : d.regex.lastIndex = 0, o++, o >= this.maxReplaces)
          break;
      }
    }), e;
  }
  nest(e, t, s = {}) {
    ...
    for (; i = this.nestingRegexp.exec(e); ) {
      ...
      if (l !== -1 && (u = i[1].slice(l).split(this.formatSeparator).map((f) => f.trim()).filter(Boolean), i[1] = i[1].slice(0, l)), n = t(o.call(this, i[1].trim(), a), a), n && i[0] === e && !g(n)) return n;
      g(n) || (n = oe(n)), n || (this.logger.warn(`missed to resolve ${i[1]} for nesting ${e}`), n = ""), u.length && (n = u.reduce((f, c) => this.format(f, c, s.lng, {
        ...s,
...
const st = (r) => {
  ...
  return (t, s, i) => {
    ...
    let o = e[a];
    return o || (o = r(H(s), i), e[a] = o), o(t);
  };
}, it = (r) => (e, t, s) => r(H(t), s)(e);
class nt {
  constructor(e = {}) {
  ...
  init(e, t = {
    ...
    const s = t.cacheInBuiltFormats ? ye : it;
    this.formats = {
      number: s((i, n) => {
  ...
  format(e, t, s, i = {}) {
    ...
    return n.reduce((o, u) => {
      ...
      if (this.formats[l]) {
        let c = o;
        try {
          const p = i?.formatParams?.[i.interpolationkey] || {}, d = p.locale || p.lng || i.locale || i.lng || s;
          c = this.formats[l](o, d, {
            ...f,
            ...i,
            ...p
          });
...
class at extends Q {
  ...
  queueLoad(e, t, s, i) {
    ...
    return e.forEach((l) => {
      ...
      t.forEach((c) => {
        const p = `${l}|${c}`;
        !s.reload && this.store.hasResourceBundle(l, c) ? this.state[p] = 2 : this.state[p] < 0 || (this.state[p] === 1 ? a[p] === void 0 && (a[p] = !0) : (this.state[p] = 1, f = !1, a[p] === void 0 && (a[p] = !0), n[p] === void 0 && (n[p] = !0), u[c] === void 0 && (u[c] = !0)));
      }), f || (o[l] = !0);
  ...
  loaded(e, t, s) {
    ...
    this.queue.forEach((u) => {
      Je(u.loaded, [n], a), rt(u, e), t && u.errors.push(t), u.pendingCount === 0 && !u.done && (Object.keys(u.loaded).forEach((l) => {
        o[l] || (o[l] = {});
        const f = u.loaded[l];
    ...
    if (!(s == null || s === "")) {
      if (this.backend?.create) {
        ...
        if (l.length < 6)
          try {
            let f;
            l.length === 5 ? f = l(e, t, s, i, u) : f = l(e, t, s, i), f && typeof f.then == "function" ? f.then((c) => o(null, c)).catch(o) : o(null, f);
          } catch (f) {
            o(f);
          }
        else
...
}), be = (r) => (g(r.ns) && (r.ns = [r.ns]), g(r.fallbackLng) && (r.fallbackLng = [r.fallbackLng]), g(r.fallbackNS) && (r.fallbackNS = [r.fallbackNS]), r.supportedLngs?.indexOf?.("cimode") < 0 && (r.supportedLngs = r.supportedLngs.concat(["cimode"])), typeof r.initImmediate == "boolean" && (r.initAsync = r.initImmediate), r), J = () => {
}, ot = (r) => {
...
class z extends Q {
  constructor(e = {}, t) {
    if (super(), this.options = be(e), this.services = {}, this.logger = E, this.modules = {
      external: []
    ...
    if (typeof e == "function" && (s = e), !this.options.resources || this.options.partialBundledLanguages) {
      ...
      const n = [], a = (o) => {
        ...
        this.services.languageUtils.toResolveHierarchy(o).forEach((l) => {
          l !== "cimode" && n.indexOf(l) < 0 && n.push(l);
        });
      };
      i ? a(i) : this.services.languageUtils.getFallbackCodes(this.options.fallbackLng).forEach((u) => a(u)), this.options.preload?.forEach?.((o) => a(o)), this.services.backendConnector.load(n, this.options.ns, (o) => {
  ...
  getFixedT(e, t, s) {
    const i = (n, a, ...o) => {
      ...
      let f;
      return u.keyPrefix && Array.isArray(n) ? f = n.map((c) => `${u.keyPrefix}${l}${c}`) : f = u.keyPrefix ? `${u.keyPrefix}${l}${n}` : n, this.t(f, u);
    };
  ...
  dir(e) {
    ...
    const t = ["ar", "shu", "sqr", "ssh", "xaa", "yhd", "yud", "aao", "abh", "abv", "acm", "acq", "acw", "acx", "acy", "adf", "ads", "aeb", "aec", "afb", "ajp", "apc", "apd", "arb", "arq", "ars", "ary", "arz", "auz", "avl", "ayh", "ayl", "ayn", "ayp", "bbz", "pga", "he", "iw", "ps", "pbt", "pbu", "pst", "prp", "prd", "ug", "ur", "ydd", "yds", "yih", "ji", "yi", "hbo", "men", "xmn", "fa", "jpr", "peo", "pes", "prs", "dv", "sam", "ckb"], s = this.services?.languageUtils || new ge(Se());
  ...
  cloneInstance(e = {}, t = J) {
    ...
    return n.translator = new G(n.services, i), n.translator.on("*", (o, ...u) => {
      n.emit(o, ...u);
...
w.createInstance = z.createInstance;
w.createInstance;
w.dir;
w.init;
w.loadResources;
