import { r as A, R as ri, a as or, k as rr, l as sr } from "./webc-vendor-BjE1NNvQ.js";
function Tn(p, c) {
  const a = A.useRef(c);
  A.useEffect(function() {
    c !== a.current && p.attributionControl != null && (a.current != null && p.attributionControl.removeAttribution(a.current), c != null && p.attributionControl.addAttribution(c)), a.current = c;
  }, [
    p,
    c
  ]);
...
const zn = A.createContext(null), Cn = zn.Provider;
function hi() {
  const p = A.useContext(zn);
  if (p == null)
...
function ur(p) {
  function c(a, f) {
    const { instance: d, context: M } = p(a).current;
    return A.useImperativeHandle(f, () => d), a.children == null ? null : /* @__PURE__ */ ri.createElement(Cn, {
      value: M
    }, a.children);
  }
  return /* @__PURE__ */ A.forwardRef(c);
}
function cr(p) {
  function c(a, f) {
    const [d, M] = A.useState(!1), { instance: g } = p(a, M).current;
    A.useImperativeHandle(f, () => g), A.useEffect(function() {
      d && g.update();
    }, [
      g,
      d,
    ...
    return W ? /* @__PURE__ */ or.createPortal(a.children, W) : null;
  }
  return /* @__PURE__ */ A.forwardRef(c);
}
function Mn(p) {
  function c(a, f) {
    const { instance: d } = p(a).current;
    return A.useImperativeHandle(f, () => d), null;
  }
  return /* @__PURE__ */ A.forwardRef(c);
}
function fr(p) {
  return function(a) {
    const f = hi(), d = p(a, f), { instance: M } = d.current, g = A.useRef(a.position), { position: W } = a;
    return A.useEffect(function() {
      return M.addTo(f.map), function() {
        M.remove();
      };
    }, [
      f.map,
      ...
      W != null && W !== g.current && (M.setPosition(W), g.current = W);
    }, [
      M,
      W
    ]), d;
...
function kn(p, c) {
  const a = A.useRef();
  A.useEffect(function() {
    return c != null && p.instance.on(c), a.current = c, function() {
      a.current != null && p.instance.off(a.current), a.current = null;
    };
  }, [
    p,
    c
...
function dr(p, c) {
  return function(f, d) {
    const M = hi(), g = p(li(f, M), M);
    return Tn(M.map, f.attribution), kn(g.current, f.eventHandlers), c(g.current, M, f, d), g;
  };
}
var si = { exports: {} };
/* @preserve
...
(function(p, c) {
  (function(a, f) {
    ...
    var Le = window.requestAnimationFrame || Pe("RequestAnimationFrame") || ci, fi = window.cancelAnimationFrame || Pe("CancelAnimationFrame") || Pe("CancelRequestAnimationFrame") || function(t) {
    ...
    ct.extend = function(t) {
      ...
      return t.statics && d(e, t.statics), t.includes && (Sn(t.includes), d.apply(null, [n].concat(t.includes))), d(n, t), delete n.statics, delete n.includes, n.options && (n.options = i.options ? M(i.options) : {}, d(n.options, t.options)), n._initHooks = [], n.callInitHooks = function() {
    ...
    }, ct.include = function(t) {
      var e = this.prototype.options;
      return d(this.prototype, t), t.options && (this.prototype.options = e, this.mergeOptions(t.options)), this;
    }, ct.mergeOptions = function(t) {
      return d(this.prototype.options, t), this;
    }, ct.addInitHook = function(t) {
    ...
    var Y = {
      ...
      _off: function(t, e, i) {
        ...
        if (this._events && (n = this._events[t], !!n)) {
          ...
          if (s !== !1) {
            var h = n[s];
            this._firingCount && (h.fn = Z, this._events[t] = n = n.slice()), n.splice(s, 1);
          }
        }
      },
        ...
        if (this._events) {
          ...
          if (o) {
            ...
            for (var r = 0, s = o.length; r < s; r++) {
              var h = o[r], l = h.fn;
              h.once && this.off(t, l, h.ctx), l.call(h.ctx || this, n);
            }
            this._firingCount--;
          }
        }
      ...
      _propagateEvent: function(t) {
        for (var e in this._eventParents)
          this._eventParents[e].fire(t.type, d({
            layer: t.target,
    ...
    w.prototype = {
      ...
      _trunc: function() {
        return this.x = di(this.x), this.y = di(this.y), this;
      },
      ...
      equals: function(t) {
        return t = y(t), t.x === this.x && t.y === this.y;
      },
    ...
    function y(t, e, i) {
      return t instanceof w ? t : nt(t) ? new w(t[0], t[1]) : t == null ? t : typeof t == "object" && "x" in t && "y" in t ? new w(t.x, t.y) : new w(t, e, i);
    }
    function I(t, e) {
      if (t)
    ...
    I.prototype = {
      ...
      getBottomLeft: function() {
        return y(this.min.x, this.max.y);
      },
      // @method getTopRight(): Point
      // Returns the top-right point of the bounds.
      getTopRight: function() {
        return y(this.max.x, this.min.y);
      },
      ...
      contains: function(t) {
        var e, i;
        return typeof t[0] == "number" || t instanceof w ? t = y(t) : t = V(t), t instanceof I ? (e = t.min, i = t.max) : e = i = t, e.x >= this.min.x && i.x <= this.max.x && e.y >= this.min.y && i.y <= this.max.y;
      },
    ...
    j.prototype = {
      ...
      extend: function(t) {
        ...
        if (t instanceof E)
          ...
          return t ? this.extend(z(t) || N(t)) : this;
      ...
      // Returns `true` if the rectangle contains the given point.
      contains: function(t) {
        typeof t[0] == "number" || t instanceof E || "lat" in t ? t = z(t) : t = N(t);
        var e = this._southWest, i = this._northEast, n, o;
    ...
    function z(t, e, i) {
      return t instanceof E ? t : nt(t) && typeof t[0] != "object" ? t.length === 3 ? new E(t[0], t[1], t[2]) : t.length === 2 ? new E(t[0], t[1]) : null : t == null ? t : typeof t == "object" && "lat" in t ? new E(t.lat, "lng" in t ? t.lng : t.lon, t.alt) : e === void 0 ? null : new E(t, e, i);
    }
    var ft = {
      ...
      wrapLatLng: function(t) {
        var e = this.wrapLng ? xt(t.lng, this.wrapLng, !0) : t.lng, i = this.wrapLat ? xt(t.lat, this.wrapLat, !0) : t.lat, n = t.alt;
        return new E(i, e, n);
      },
      ...
      wrapLatLngBounds: function(t) {
        ...
        if (n === 0 && o === 0)
          return t;
        var r = t.getSouthWest(), s = t.getNorthEast(), h = new E(r.lat - n, r.lng - o), l = new E(s.lat - n, s.lng - o);
        return new j(h, l);
      }
    }, gt = d({}, ft, {
      wrapLng: [-180, 180],
      ...
      distance: function(t, e) {
        var i = Math.PI / 180, n = t.lat * i, o = e.lat * i, r = Math.sin((e.lat - t.lat) * i / 2), s = Math.sin((e.lng - t.lng) * i / 2), h = r * r + Math.cos(n) * Math.cos(o) * s * s, l = 2 * Math.atan2(Math.sqrt(h), Math.sqrt(1 - h));
        return this.R * l;
      }
    }), _i = 6378137, Te = {
      R: _i,
    ...
    function mi(t, e) {
      ...
      for (n = 0, r = t.length; n < r; n++) {
        for (h = t[n], o = 0, s = h.length; o < s; o++)
          l = h[o], i += (o ? "L" : "M") + l.x + " " + l.y;
        i += e ? m.svg ? "z" : "x" : "";
      }
      return i || "M0 0";
    }
    var Me = document.documentElement.style, ee = "ActiveXObject" in window, Zn = ee && !document.addEventListener, gi = "msLaunchUri" in navigator && !("documentMode" in document), ke = st("webkit"), vi = st("android"), yi = st("android 2") || st("android 3"), In = parseInt(/WebKit\/([0-9]+)|$/.exec(navigator.userAgent)[1], 10), Bn = vi && st("Google") && In < 537 && !("AudioNode" in window), Ae = !!window.opera, xi = !gi && st("chrome"), wi = st("gecko") && !ke && !Ae && !ee, Rn = !xi && st("safari"), bi = st("phantom"), Pi = "OTransition" in Me, Nn = navigator.platform.indexOf("Win") === 0, Li = ee && "transition" in Me, Ee = "WebKitCSSMatrix" in window && "m11" in new window.WebKitCSSMatrix() && !yi, Ti = "MozPerspective" in Me, Dn = !window.L_DISABLE_3D && (Li || Ee || Ti) && !Pi && !bi, Dt = typeof orientation < "u" || st("mobile"), Hn = Dt && ke, Wn = Dt && Ee, zi = !window.PointerEvent && window.MSPointerEvent, Ci = !!(window.PointerEvent || zi), Mi = "ontouchstart" in window || !!window.TouchEvent, Fn = !window.L_NO_TOUCH && (Mi || Ci), Un = Dt && Ae, qn = Dt && wi, Gn = (window.devicePixelRatio || window.screen.deviceXDPI / window.screen.logicalXDPI) > 1, Vn = function() {
      var t = !1;
      try {
    ...
    }(), Se = !!(document.createElementNS && pi("svg").createSVGRect), Kn = !!Se && function() {
    ...
    var m = {
      ...
      mac: Jn,
      linux: Xn
    }, ki = m.msPointer ? "MSPointerDown" : "pointerdown", Ai = m.msPointer ? "MSPointerMove" : "pointermove", Ei = m.msPointer ? "MSPointerUp" : "pointerup", Si = m.msPointer ? "MSPointerCancel" : "pointercancel", Oe = {
      touchstart: ki,
      touchmove: Ai,
      touchend: Ei,
      touchcancel: Si
    ...
    function Qn(t, e, i) {
      return e === "touchstart" && io(), Oi[e] ? (i = Oi[e].bind(this, i), t.addEventListener(Oe[e], i, !1), i) : (console.warn("wrong event specified:", e), Z);
    }
    function $n(t, e, i) {
      if (!Oe[e]) {
    ...
    function io() {
      Zi || (document.addEventListener(ki, to, !0), document.addEventListener(Ai, eo, !0), document.addEventListener(Ei, Ii, !0), document.addEventListener(Si, Ii, !0), Zi = !0);
    }
    function ie(t, e) {
    ...
    function no(t, e) {
      e.MSPOINTER_TYPE_TOUCH && e.pointerType === e.MSPOINTER_TYPE_TOUCH && U(e), ie(t, e);
    }
    function oo(t) {
      var e = {}, i, n;
      for (n in t)
    ...
    ), Bi = Ht === "webkitTransition" || Ht === "OTransition" ? Ht + "End" : "transitionend";
    function Ri(t) {
    ...
    function R(t, e) {
      t.classList !== void 0 ? t.classList.remove(e) : Be(t, it((" " + oe(t) + " ").replace(" " + e + " ", " ")));
    }
    function Be(t, e) {
    ...
    function Q(t, e) {
      "opacity" in t.style ? t.style.opacity = e : "filter" in t.style && ho(t, e);
    }
    function ho(t, e) {
    ...
    function D(t, e) {
      t._leaflet_pos = e, m.any3d ? bt(t, e) : (t.style.left = e.x + "px", t.style.top = e.y + "px");
    }
    function Pt(t) {
    ...
    if ("onselectstart" in document)
      ...
      Ft = function() {
        ...
        qt && (document.documentElement.style[qt] = Re, Re = void 0);
      };
    }
    function Ne() {
      b(window, "dragstart", U);
    }
    function De() {
    ...
    function We(t) {
      for (; t.tabIndex === -1; )
        t = t.parentNode;
      t.style && (ae(), se = t, He = t.style.outlineStyle, t.style.outlineStyle = "none", b(window, "keydown", ae));
    }
    function ae() {
      se && (se.style.outlineStyle = He, se = void 0, He = void 0, O(window, "keydown", ae));
    }
    function Ni(t) {
      do
        t = t.parentNode;
    ...
    function qe(t, e, i, n) {
      ...
      !m.touchNative && m.pointer && e.indexOf("touch") === 0 ? r = Qn(t, e, r) : m.touch && e === "dblclick" ? r = so(t, r) : "addEventListener" in t ? e === "touchstart" || e === "touchmove" || e === "wheel" || e === "mousewheel" ? t.addEventListener(Ue[e] || e, r, m.passiveEvents ? { passive: !1 } : !1) : e === "mouseenter" || e === "mouseleave" ? (r = function(h) {
        h = h || window.event, je(t, h) && s(h);
      }, t.addEventListener(Ue[e], r, !1)) : t.addEventListener(e, s, !1) : t.attachEvent("on" + e, r), t[at] = t[at] || {}, t[at][o] = r;
    }
    function Ge(t, e, i, n, o) {
      ...
      if (!r)
        return this;
      !m.touchNative && m.pointer && e.indexOf("touch") === 0 ? $n(t, e, r) : m.touch && e === "dblclick" ? ao(t, r) : "removeEventListener" in t ? t.removeEventListener(Ue[e] || e, r, !1) : t.detachEvent("on" + e, r), t[at][o] = null;
    }
    function Lt(t) {
    ...
    function Gt(t) {
      return b(t, "mousedown touchstart dblclick contextmenu", Lt), t._leaflet_disable_click = !0, this;
    }
    function U(t) {
      return t.preventDefault ? t.preventDefault() : t.returnValue = !1, this;
    }
    function Tt(t) {
      return U(t), Lt(t), this;
    }
    function Hi(t) {
      if (t.composedPath)
    ...
    var uo = m.linux && m.chrome ? window.devicePixelRatio : m.mac ? window.devicePixelRatio * 3 : window.devicePixelRatio > 0 ? 2 * window.devicePixelRatio : 1;
    function Fi(t) {
      return m.edge ? t.wheelDeltaY / 2 : (
        // Don't trust window-geometry-based delta
        t.deltaY && t.deltaMode === 0 ? -t.deltaY / uo : (
          // Pixels
    ...
    var co = {
      ...
      setView: function(t, e, i) {
        if (e = e === void 0 ? this._zoom : this._limitZoom(e), t = this._limitCenter(z(t), e, this.options.maxBounds), i = i || {}, this._stop(), this._loaded && !i.reset && i !== !0) {
          i.animate !== void 0 && (i.zoom = d({ animate: i.animate }, i.zoom), i.pan = d({ animate: i.animate, duration: i.duration }, i.pan));
      ...
      setZoomAround: function(t, e, i) {
        var n = this.getZoomScale(e), o = this.getSize().divideBy(2), r = t instanceof w ? t : this.latLngToContainerPoint(t), s = r.subtract(o).multiplyBy(1 - 1 / n), h = this.containerPointToLatLng(o.add(s));
        return this.setView(h, e, { zoom: i });
      },
      _getBoundsCenterZoom: function(t, e) {
        e = e || {}, t = t.getBounds ? t.getBounds() : N(t);
        var i = y(e.paddingTopLeft || e.padding || [0, 0]), n = y(e.paddingBottomRight || e.padding || [0, 0]), o = this.getBoundsZoom(t, !1, i.add(n));
        if (o = typeof e.maxZoom == "number" ? Math.min(e.maxZoom, o) : o, o === 1 / 0)
          return {
            center: t.getCenter(),
            zoom: o
          };
        var r = n.subtract(i).divideBy(2), s = this.project(t.getSouthWest(), o), h = this.project(t.getNorthEast(), o), l = this.unproject(s.add(h).divideBy(2).add(r), o);
        return {
          center: l,
          zoom: o
        };
      ...
      flyTo: function(t, e, i) {
        ...
        t = z(t), e = e === void 0 ? s : e;
        var h = Math.max(r.x, r.y), l = h * this.getZoomScale(s, e), u = o.distanceTo(n) || 1, _ = 1.42, v = _ * _;
        function T(H) {
          var ye = H ? -1 : 1, tr = H ? l : h, er = l * l - h * h + ye * v * v * u * u, ir = 2 * tr * v * u, oi = er / ir, Ln = Math.sqrt(oi * oi + 1) - oi, nr = Ln < 1e-9 ? -18 : Math.log(Ln);
          return nr;
        }
        function q(H) {
        ...
        var K = T(0);
        function It(H) {
          return h * (F(K) / F(K + _ * H));
        }
        function Jo(H) {
          return h * (F(K) * tt(K + _ * H) - q(K)) / v;
        }
        function Xo(H) {
          return 1 - Math.pow(1 - H, 1.5);
        }
        var Qo = Date.now(), bn = (T(1) - K) / _, $o = i.duration ? 1e3 * i.duration : 1e3 * bn * 0.8;
        function Pn() {
          var H = (Date.now() - Qo) / $o, ye = Xo(H) * bn;
          H <= 1 ? (this._flyToFrame = G(Pn, this), this._move(
            this.unproject(n.add(o.subtract(n).multiplyBy(Jo(ye) / u)), s),
            this.getScaleZoom(h / It(ye), s),
            { flyTo: !0 }
      ...
      panInside: function(t, e) {
        e = e || {};
        var i = y(e.paddingTopLeft || e.padding || [0, 0]), n = y(e.paddingBottomRight || e.padding || [0, 0]), o = this.project(this.getCenter()), r = this.project(t), s = this.getPixelBounds(), h = V([s.min.add(i), s.max.subtract(n)]), l = h.getSize();
        if (!h.contains(r)) {
          this._enforcingBounds = !0;
          var u = r.subtract(h.getCenter()), _ = h.extend(r).getSize().subtract(l);
          o.x += u.x < 0 ? -_.x : _.x, o.y += u.y < 0 ? -_.y : _.y, this.panTo(this.unproject(o), e), this._enforcingBounds = !1;
        }
        return this;
      },
      ...
      invalidateSize: function(t) {
        ...
        return !r.x && !r.y ? this : (t.animate && t.pan ? this.panBy(r) : (t.pan && this._rawPanBy(r), this.fire("move"), t.debounceMoveend ? (clearTimeout(this._sizeTimer), this._sizeTimer = setTimeout(g(this.fire, this, "moveend"), 200)) : this.fire("moveend")), this.fire("resize", {
          oldSize: e,
          newSize: i
        }));
      },
      ...
      _handleGeolocationResponse: function(t) {
        if (this._container._leaflet_id) {
          var e = t.coords.latitude, i = t.coords.longitude, n = new E(e, i), o = n.toBounds(t.coords.accuracy * 2), r = this._locateOptions;
          if (r.setView) {
          ...
          for (var l in t.coords)
            typeof t.coords[l] == "number" && (h[l] = t.coords[l]);
      ...
      remove: function() {
        ...
        this._locationWatchId !== void 0 && this.stopLocate(), this._stop(), B(this._mapPane), this._clearControlPos && this._clearControlPos(), this._resizeRequest && (X(this._resizeRequest), this._resizeRequest = null), this._clearHandlers(), this._loaded && this.fire("unload");
        var t;
      ...
      getBoundsZoom: function(t, e, i) {
        t = N(t), i = y(i || [0, 0]);
        var n = this.getZoom() || 0, o = this.getMinZoom(), r = this.getMaxZoom(), s = t.getNorthWest(), h = t.getSouthEast(), l = this.getSize().subtract(i), u = V(this.project(h, n), this.project(s, n)).getSize(), _ = m.any3d ? this.options.zoomSnap : 1, v = l.x / u.x, T = l.y / u.y, q = e ? Math.max(v, T) : Math.min(v, T);
        return n = this.getScaleZoom(q, n), _ && (n = Math.round(n / (_ / 100)) * (_ / 100), n = e ? Math.ceil(n / _) * _ : Math.floor(n / _) * _), Math.max(o, Math.min(r, n));
      },
      // @method getSize(): Point
      ...
      unproject: function(t, e) {
        return e = e === void 0 ? this._zoom : e, this.options.crs.pointToLatLng(y(t), e);
      },
      ...
      _initContainer: function(t) {
        ...
        b(e, "scroll", this._onScroll, this), this._containerId = x(e);
      },
      _initLayout: function() {
        var t = this._container;
        this._fadeAnimated = this.options.fadeAnimation && m.any3d, P(t, "leaflet-container" + (m.touch ? " leaflet-touch" : "") + (m.retina ? " leaflet-retina" : "") + (m.ielt9 ? " leaflet-oldie" : "") + (m.safari ? " leaflet-safari" : "") + (this._fadeAnimated ? " leaflet-fade-anim" : ""));
        var e = Wt(t, "position");
      ...
      _findEventTargets: function(t, e) {
        for (var i = [], n, o = e === "mouseout" || e === "mouseover", r = t.target || t.srcElement, s = !1; r; ) {
          if (n = this._targets[x(r)], n && (e === "click" || e === "preclick") && this._draggableMoved(n)) {
            s = !0;
            break;
          }
      ...
      _fireDOMEvent: function(t, e, i) {
        ...
        if (o.length) {
          ...
          for (s = 0; s < o.length; s++)
            if (o[s].fire(e, l, !0), l.originalEvent._stopped || o[s].options.bubblingMouseEvents === !1 && be(this._mouseEvents, e) !== -1)
              return;
        }
      },
      ...
      _getMapPanePos: function() {
        return Pt(this._mapPane) || new w(0, 0);
      },
      _moved: function() {
        var t = this._getMapPanePos();
      ...
      _limitCenter: function(t, e, i) {
        if (!i)
          return t;
        var n = this.project(t, e), o = this.getSize().divideBy(2), r = new I(n.subtract(o), n.add(o)), s = this._getBoundsOffset(r, i, e);
      ...
      _getBoundsOffset: function(t, e, i) {
        ...
        ), o = n.min.subtract(t.min), r = n.max.subtract(t.max), s = this._rebound(o.x, -r.x), h = this._rebound(o.y, -r.y);
        return new w(s, h);
      },
      ...
      _createAnimProxy: function() {
        ...
        this._panes.mapPane.appendChild(t), this.on("zoomanim", function(e) {
          ...
          bt(this._proxy, this.project(e.center, e.zoom), this.getZoomScale(e.zoom, 1)), n === this._proxy.style[i] && this._animatingZoom && this._onZoomTransitionEnd();
    ...
    var qi = ot.extend({
      ...
      expand: function() {
        ...
        return t < this._section.clientHeight ? (P(this._section, "leaflet-control-layers-scrollbar"), this._section.style.height = t + "px") : R(this._section, "leaflet-control-layers-scrollbar"), this._checkDisabledLayers(), this;
      },
      ...
      _initLayout: function() {
        ...
        e.setAttribute("aria-haspopup", !0), Gt(e), Ve(e);
      ...
      _addItem: function(t) {
        ...
        t.overlay ? (n = document.createElement("input"), n.type = "checkbox", n.className = "leaflet-control-layers-selector", n.defaultChecked = i) : n = this._createRadioElement("leaflet-base-layers_" + x(this), i), this._layerControlInputs.push(n), n.layerId = x(t.layer), b(n, "click", this._onInputClick, this);
      ...
      _expandSafely: function() {
        var t = this._section;
        this._preventClick = !0, b(t, "click", U), this.expand();
        var e = this;
        setTimeout(function() {
          O(t, "click", U), e._preventClick = !1;
        });
      }
    }), _o = function(t, e, i) {
      return new qi(t, e, i);
      ...
      _createButton: function(t, e, i, n, o) {
        var r = k("a", i, n);
        return r.innerHTML = t, r.href = "#", r.title = e, r.setAttribute("role", "button"), r.setAttribute("aria-label", e), Gt(r), b(r, "click", Tt), b(r, "click", o, this), b(r, "click", this._refocusOnMap, this), r;
      },
      _updateDisabled: function() {
        var t = this._map, e = "leaflet-disabled";
        R(this._zoomInButton, e), R(this._zoomOutButton, e), this._zoomInButton.setAttribute("aria-disabled", "false"), this._zoomOutButton.setAttribute("aria-disabled", "false"), (this._disabled || t._zoom === t.getMinZoom()) && (P(this._zoomOutButton, e), this._zoomOutButton.setAttribute("aria-disabled", "true")), (this._disabled || t._zoom === t.getMaxZoom()) && (P(this._zoomInButton, e), this._zoomInButton.setAttribute("aria-disabled", "true"));
      }
    });
    C.mergeOptions({
      zoomControl: !0
    ...
    var po = function(t) {
      ...
      return new Gi(t);
    }, go = '<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="12" height="8" viewBox="0 0 12 8" class="leaflet-attribution-flag"><path fill="#4C7BE1" d="M0 0h12v4H0z"/><path fill="#FFD500" d="M0 4h12v3H0z"/><path fill="#E0BC00" d="M0 7h12v1H0z"/></svg>', Ye = ot.extend({
      // @section
      ...
      options: {
        ...
        prefix: '<a href="https://leafletjs.com" title="A JavaScript library for interactive maps">' + (m.inlineSvg ? go + " " : "") + "Leaflet</a>"
      },
      initialize: function(t) {
        S(this, t), this._attributions = {};
      },
      onAdd: function(t) {
        t.attributionControl = this, this._container = k("div", "leaflet-control-attribution"), Gt(this._container);
    ...
    ot.Layers = qi, ot.Zoom = Ke, ot.Scale = Gi, ot.Attribution = Ye, Vt.layers = _o, Vt.zoom = po, Vt.scale = mo, Vt.attribution = vo;
    var ht = ct.extend({
      initialize: function(t) {
        this._map = t;
      },
    ...
    var yo = { Events: Y }, Vi = m.touch ? "touchstart mousedown" : "mousedown", vt = Rt.extend({
      options: {
        // @section
      ...
      enable: function() {
        this._enabled || (b(this._dragStartTarget, Vi, this._onDown, this), this._enabled = !0);
      },
      // @method disable()
      // Disables the dragging ability
      disable: function() {
        this._enabled && (vt._dragging === this && this.finishDrag(!0), O(this._dragStartTarget, Vi, this._onDown, this), this._enabled = !1, this._moved = !1);
      },
      _onDown: function(t) {
        if (this._enabled && (this._moved = !1, !Ie(this._element, "leaflet-zoom-anim"))) {
          ...
          if (!(vt._dragging || t.shiftKey || t.which !== 1 && t.button !== 1 && !t.touches) && (vt._dragging = this, this._preventOutline && We(this._element), Ne(), Ft(), !this._moving)) {
            this.fire("down");
            var e = t.touches ? t.touches[0] : t, i = Ni(this._element);
            this._startPoint = new w(e.clientX, e.clientY), this._startPos = Pt(this._element), this._parentScale = Fe(i);
      ...
      _onMove: function(t) {
        if (this._enabled) {
          ...
          !i.x && !i.y || Math.abs(i.x) + Math.abs(i.y) < this.options.clickTolerance || (i.x /= this._parentScale.x, i.y /= this._parentScale.y, U(t), this._moved || (this.fire("dragstart"), this._moved = !0, P(document.body, "leaflet-dragging"), this._lastTarget = t.target || t.srcElement, window.SVGElementInstance && this._lastTarget instanceof window.SVGElementInstance && (this._lastTarget = this._lastTarget.correspondingUseElement), P(this._lastTarget, "leaflet-drag-target")), this._newPos = this._startPos.add(i), this._moving = !0, this._lastEvent = t, this._updatePosition());
        }
      },
      ...
      finishDrag: function(t) {
        R(document.body, "leaflet-dragging"), this._lastTarget && (R(this._lastTarget, "leaflet-drag-target"), this._lastTarget = null), O(document, "mousemove touchmove", this._onMove, this), O(document, "mouseup touchend touchcancel", this._onUp, this), De(), Ut();
    ...
    function ji(t, e, i) {
      var n, o = [1, 4, 2, 8], r, s, h, l, u, _, v, T;
      for (r = 0, _ = t.length; r < _; r++)
        t[r]._code = zt(t[r], e);
      for (h = 0; h < 4; h++) {
        for (v = o[h], n = [], r = 0, _ = t.length, s = _ - 1; r < _; s = r++)
          l = t[r], u = t[s], l._code & v ? u._code & v || (T = he(u, l, v, e, i), T._code = zt(T, e), n.push(T)) : (u._code & v && (T = he(u, l, v, e, i), T._code = zt(T, e), n.push(T)), n.push(l));
        t = n;
      }
      return t;
    }
    function Ki(t, e) {
      var i, n, o, r, s, h, l, u, _;
      if (!t || t.length === 0)
        throw new Error("latlngs not passed");
      $(t) || (console.warn("latlngs are not flat! Only the first ring will be used"), t = t[0]);
      var v = z([0, 0]), T = N(t), q = T.getNorthWest().distanceTo(T.getSouthWest()) * T.getNorthEast().distanceTo(T.getNorthWest());
      q < 1700 && (v = Je(t));
      var F = t.length, tt = [];
      for (i = 0; i < F; i++) {
        var K = z(t[i]);
        tt.push(e.project(z([K.lat - v.lat, K.lng - v.lng])));
      }
      for (h = l = u = 0, i = 0, n = F - 1; i < F; n = i++)
        o = tt[i], r = tt[n], s = o.y * r.x - r.y * o.x, l += (o.x + r.x) * s, u += (o.y + r.y) * s, h += s * 3;
      h === 0 ? _ = tt[0] : _ = [l / h, u / h];
      var It = e.unproject(y(_));
      return z([It.lat + v.lat, It.lng + v.lng]);
    }
    function Je(t) {
    ...
    function Xe(t, e, i, n, o) {
      var r = 0, s, h, l;
      for (h = n + 1; h <= o - 1; h++)
        l = jt(t[h], t[n], t[o], !0), l > r && (s = h, r = l);
    ...
    function Qi(t, e, i, n, o) {
      var r = n ? Xi : zt(t, i), s = zt(e, i), h, l, u;
      for (Xi = s; ; ) {
        if (!(r | s))
          return [t, e];
        if (r & s)
          return !1;
        h = r || s, l = he(t, e, h, i, o), u = zt(l, i), h === r ? (t = l, r = u) : (e = l, s = u);
      }
    }
    function he(t, e, i, n, o) {
      var r = e.x - t.x, s = e.y - t.y, h = n.min, l = n.max, u, _;
      return i & 8 ? (u = t.x + r * (l.y - t.y) / s, _ = l.y) : i & 4 ? (u = t.x + r * (h.y - t.y) / s, _ = h.y) : i & 2 ? (u = l.x, _ = t.y + s * (l.x - t.x) / r) : i & 1 && (u = h.x, _ = t.y + s * (h.x - t.x) / r), new w(u, _, o);
    }
    function zt(t, e) {
      var i = 0;
    ...
    function jt(t, e, i, n) {
      var o = e.x, r = e.y, s = i.x - o, h = i.y - r, l = s * s + h * h, u;
      return l > 0 && (u = ((t.x - o) * s + (t.y - r) * h) / l, u > 1 ? (o = i.x, r = i.y) : u > 0 && (o += s * u, r += h * u)), s = t.x - o, h = t.y - r, n ? s * s + h * h : new w(o, r);
    }
    function $(t) {
    ...
    function tn(t, e) {
      ...
      if (!t || t.length === 0)
        throw new Error("latlngs not passed");
      $(t) || (console.warn("latlngs are not flat! Only the first ring will be used"), t = t[0]);
      var _ = z([0, 0]), v = N(t), T = v.getNorthWest().distanceTo(v.getSouthWest()) * v.getNorthEast().distanceTo(v.getNorthWest());
      T < 1700 && (_ = Je(t));
      var q = t.length, F = [];
      for (i = 0; i < q; i++) {
        var tt = z(t[i]);
        F.push(e.project(z([tt.lat - _.lat, tt.lng - _.lng])));
      }
      for (i = 0, n = 0; i < q - 1; i++)
        n += F[i].distanceTo(F[i + 1]) / 2;
      if (n === 0)
        u = F[0];
      else
        for (i = 0, r = 0; i < q - 1; i++)
          if (s = F[i], h = F[i + 1], o = s.distanceTo(h), r += o, r > n) {
            l = (r - n) / o, u = [
              h.x - l * (h.x - s.x),
              h.y - l * (h.y - s.y)
            ];
      ...
      var K = e.unproject(y(u));
      return z([K.lat + _.lat, K.lng + _.lng]);
    }
    var To = {
      __proto__: null,
      simplify: Yi,
      ...
      project: function(t) {
        var e = Math.PI / 180, i = this.R, n = t.lat * e, o = this.R_MINOR / i, r = Math.sqrt(1 - o * o), s = r * Math.sin(n), h = Math.tan(Math.PI / 4 - n / 2) / Math.pow((1 - s) / (1 + s), r / 2);
        return n = -i * Math.log(Math.max(h, 1e-10)), new w(t.lng * e * i, n);
      },
      unproject: function(t) {
        for (var e = 180 / Math.PI, i = this.R, n = this.R_MINOR / i, o = Math.sqrt(1 - n * n), r = Math.exp(-t.y / i), s = Math.PI / 2 - 2 * Math.atan(r), h = 0, l = 0.1, u; h < 15 && Math.abs(l) > 1e-7; h++)
          u = o * Math.sin(s), u = Math.pow((1 - u) / (1 + u), o / 2), l = Math.PI / 2 - 2 * Math.atan(r * u) - s, s += l;
        return new E(s * e, t.x * e / i);
      }
    }, zo = {
      __proto__: null,
      LonLat: Qe,
    ...
    ft.Earth = gt, ft.EPSG3395 = Co, ft.EPSG3857 = Ce, ft.EPSG900913 = On, ft.EPSG4326 = en, ft.Simple = Mo;
    var rt = Rt.extend({
    ...
    var At = rt.extend({
      ...
      addLayer: function(t) {
        return this.hasLayer(t) ? this : (t.addEventParent(this), At.prototype.addLayer.call(this, t), this.fire("layeradd", { layer: t }));
      },
      removeLayer: function(t) {
        return this.hasLayer(t) ? (t in this._layers && (t = this._layers[t]), t.removeEventParent(this), At.prototype.removeLayer.call(this, t), this.fire("layerremove", { layer: t })) : this;
      },
      ...
      _setIconStyles: function(t, e) {
        ...
        var o = y(n), r = y(e === "shadow" && i.shadowAnchor || i.iconAnchor || o && o.divideBy(2, !0));
    ...
    var Kt = Et.extend({
      ...
      _getIconUrl: function(t) {
        return typeof Kt.imagePath != "string" && (Kt.imagePath = this._detectIconPath()), (this.options.imagePath || Kt.imagePath) + Et.prototype._getIconUrl.call(this, t);
      },
      ...
      _detectIconPath: function() {
        var t = k("div", "leaflet-default-icon-path", document.body), e = Wt(t, "background-image") || Wt(t, "backgroundImage");
      ...
      _adjustPan: function(t) {
        var e = this._marker, i = e._map, n = this._marker.options.autoPanSpeed, o = this._marker.options.autoPanPadding, r = Pt(e._icon), s = i.getPixelBounds(), h = i.getPixelOrigin(), l = V(
          s.min._subtract(h).add(o),
          s.max._subtract(h).subtract(o)
        );
        if (!l.contains(r)) {
          var u = y(
          ...
          i.panBy(u, { animate: !1 }), this._draggable._newPos._add(u), this._draggable._startPos._add(u), D(e._icon, this._draggable._newPos), this._onDrag(t), this._panRequest = G(this._adjustPan.bind(this, t));
        }
      },
      ...
      _initIcon: function() {
        ...
        o !== this._shadow && (this._removeShadow(), r = !0), o && (P(o, e), o.alt = ""), this._shadow = o, t.opacity < 1 && this._updateOpacity(), n && this.getPane().appendChild(this._icon), this._initInteraction(), o && r && this.getPane(t.shadowPane).appendChild(this._shadow);
      },
      _removeIcon: function() {
        this.options.riseOnHover && this.off({
          mouseover: this._bringToFront,
          mouseout: this._resetZIndex
        }), this.options.autoPanOnFocus && O(this._icon, "focus", this._panOnFocus, this), B(this._icon), this.removeInteractiveTarget(this._icon), this._icon = null;
      },
      ...
      _initInteraction: function() {
        if (this.options.interactive && (P(this._icon, "leaflet-interactive"), this.addInteractiveTarget(this._icon), nn)) {
      ...
      _panOnFocus: function() {
        var t = this._map;
        if (t) {
          var e = this.options.icon.options, i = e.iconSize ? y(e.iconSize) : y(0, 0), n = e.iconAnchor ? y(e.iconAnchor) : y(0, 0);
    ...
    var yt = rt.extend({
      ...
      initialize: function(t, e) {
        S(this, e), this._latlng = z(t), this._radius = this.options.radius;
      },
      // @method setLatLng(latLng: LatLng): this
    ...
    var ti = ue.extend({
      initialize: function(t, e, i) {
        if (typeof e == "number" && (e = d({}, i, { radius: e })), S(this, e), this._latlng = z(t), isNaN(this.options.radius))
      ...
      _project: function() {
        ...
        if (n.distance === gt.distance) {
          var o = Math.PI / 180, r = this._mRadius / gt.R / o, s = i.project([e + r, t]), h = i.project([e - r, t]), l = s.add(h).divideBy(2), u = i.unproject(l).lat, _ = Math.acos((Math.cos(r * o) - Math.sin(e * o) * Math.sin(u * o)) / (Math.cos(e * o) * Math.cos(u * o))) / o;
          (isNaN(_) || _ === 0) && (_ = r / Math.cos(Math.PI / 180 * e)), this._point = l.subtract(i.getPixelOrigin()), this._radius = isNaN(_) ? 0 : l.x - i.project([u, t - _]).x, this._radiusY = l.y - s.y;
        } else {
    ...
    var _t = yt.extend({
      ...
      closestLayerPoint: function(t) {
        for (var e = 1 / 0, i = null, n = jt, o, r, s = 0, h = this._parts.length; s < h; s++)
          for (var l = this._parts[s], u = 1, _ = l.length; u < _; u++) {
            o = l[u - 1], r = l[u];
            var v = n(t, o, r, !0);
            v < e && (e = v, i = n(t, o, r));
          }
      ...
      _updateBounds: function() {
        var t = this._clickTolerance(), e = new w(t, t);
        this._rawPxBounds && (this._pxBounds = new I([
      ...
      _projectLatlngs: function(t, e, i) {
        var n = t[0] instanceof E, o = t.length, r, s;
        if (n) {
          for (s = [], r = 0; r < o; r++)
      ...
      _clipPoints: function() {
        ...
        if (this._parts = [], !(!this._pxBounds || !this._pxBounds.intersects(t))) {
          ...
          var e = this._parts, i, n, o, r, s, h, l;
          for (i = 0, o = 0, r = this._rings.length; i < r; i++)
            for (l = this._rings[i], n = 0, s = l.length; n < s - 1; n++)
              h = Qi(l[n], l[n + 1], t, n, !0), h && (e[o] = e[o] || [], e[o].push(h[0]), (h[1] !== l[n + 1] || n === s - 2) && (e[o].push(h[1]), o++));
        }
      },
      ...
      _containsPoint: function(t, e) {
        var i, n, o, r, s, h, l = this._clickTolerance();
        if (!this._pxBounds || !this._pxBounds.contains(t))
          return !1;
        for (i = 0, r = this._parts.length; i < r; i++)
          for (h = this._parts[i], n = 0, s = h.length, o = s - 1; n < s; o = n++)
            if (!(!e && n === 0) && Ji(t, h[o], h[n]) <= l)
              return !0;
        return !1;
      }
    });
    ...
    var St = _t.extend({
      ...
      // Needed by the `Canvas` renderer for interactivity
      _containsPoint: function(t) {
        var e = !1, i, n, o, r, s, h, l, u;
        if (!this._pxBounds || !this._pxBounds.contains(t))
          return !1;
        for (r = 0, l = this._parts.length; r < l; r++)
          for (i = this._parts[r], s = 0, u = i.length, h = u - 1; s < u; h = s++)
            n = i[s], o = i[h], n.y > t.y != o.y > t.y && t.x < (o.x - n.x) * (t.y - n.y) / (o.y - n.y) + n.x && (e = !e);
    ...
    var pt = dt.extend({
      ...
      addData: function(t) {
        ...
        if (r.filter && !r.filter(t))
          return this;
        var s = ce(t, r);
        return s ? (s.feature = _e(t), s.defaultOptions = s.options, this.resetStyle(s), r.onEachFeature && r.onEachFeature(t, s), this.addLayer(s)) : this;
      },
      // @method resetStyle( <Path> layer? ): this
      // Resets the given vector layer's style to the original GeoJSON style, useful for resetting style after hover events.
      // If `layer` is omitted, the style of all features in the current layer is reset.
      resetStyle: function(t) {
        return t === void 0 ? this.eachLayer(this.resetStyle, this) : (t.options = d({}, t.defaultOptions), this._setLayerStyle(t, this.options.style), this);
      },
    ...
    function ce(t, e) {
      var i = t.type === "Feature" ? t.geometry : t, n = i ? i.coordinates : null, o = [], r = e && e.pointToLayer, s = e && e.coordsToLatLng || ei, h, l, u, _;
      if (!n && !i)
        return null;
      switch (i.type) {
        case "Point":
          return h = s(n), on(r, t, h, e);
        case "MultiPoint":
          for (u = 0, _ = n.length; u < _; u++)
            h = s(n[u]), o.push(on(r, t, h, e));
          return new dt(o);
        case "LineString":
        case "MultiLineString":
          return l = fe(n, i.type === "LineString" ? 0 : 1, s), new _t(l, e);
        case "Polygon":
        case "MultiPolygon":
          return l = fe(n, i.type === "Polygon" ? 1 : 2, s), new St(l, e);
        case "GeometryCollection":
          for (u = 0, _ = i.geometries.length; u < _; u++) {
            var v = ce({
        ...
        case "FeatureCollection":
          for (u = 0, _ = i.features.length; u < _; u++) {
            var T = ce(i.features[u], e);
            T && o.push(T);
          }
          return new dt(o);
        default:
    ...
    function fe(t, e, i) {
      for (var n = [], o = 0, r = t.length, s; o < r; o++)
        s = e ? fe(t[o], e - 1, i) : (i || ei)(t[o]), n.push(s);
      return n;
    }
    function ii(t, e) {
      return t = z(t), t.alt !== void 0 ? [J(t.lng, e), J(t.lat, e), J(t.alt, e)] : [J(t.lng, e), J(t.lat, e)];
    }
    function de(t, e, i, n) {
      for (var o = [], r = 0, s = t.length; r < s; r++)
        o.push(e ? de(t[r], $(t[r]) ? 0 : e - 1, i, n) : ii(t[r], n));
      return !e && i && o.length > 0 && o.push(o[0].slice()), o;
    }
    function Ot(t, e) {
      return t.feature ? d({}, t.feature, { geometry: e }) : _e(e);
    }
    function _e(t) {
    ...
    le.include(ni), ti.include(ni), ue.include(ni), _t.include({
      toGeoJSON: function(t) {
        var e = !$(this._latlngs), i = de(this._latlngs, e ? 1 : 0, !1, t);
        return Ot(this, {
      ...
      toGeoJSON: function(t) {
        var e = !$(this._latlngs), i = e && !$(this._latlngs[0]), n = de(this._latlngs, i ? 2 : e ? 1 : 0, !0, t);
    ...
    var Ro = rn, pe = rt.extend({
      ...
      initialize: function(t, e, i) {
        this._url = t, this._bounds = N(e), S(this, i);
      },
      onAdd: function() {
      ...
      _initImage: function() {
        ...
        if (P(e, "leaflet-image-layer"), this._zoomAnimated && P(e, "leaflet-zoom-animated"), this.options.className && P(e, this.options.className), e.onselectstart = Z, e.onmousemove = Z, e.onload = g(this.fire, this, "load"), e.onerror = g(this._overlayOnError, this, "error"), (this.options.crossOrigin || this.options.crossOrigin === "") && (e.crossOrigin = this.options.crossOrigin === !0 ? "" : this.options.crossOrigin), this.options.zIndex && this._updateZIndex(), t) {
          this._url = e.src;
          return;
        }
      ...
      _initImage: function() {
        ...
        if (P(e, "leaflet-image-layer"), this._zoomAnimated && P(e, "leaflet-zoom-animated"), this.options.className && P(e, this.options.className), e.onselectstart = Z, e.onmousemove = Z, e.onloadeddata = g(this.fire, this, "load"), t) {
    ...
    var an = pe.extend({
      _initImage: function() {
        ...
        P(t, "leaflet-image-layer"), this._zoomAnimated && P(t, "leaflet-zoom-animated"), this.options.className && P(t, this.options.className), t.onselectstart = Z, t.onmousemove = Z;
      }
    ...
    var lt = rt.extend({
      ...
      initialize: function(t, e) {
        t && (t instanceof E || nt(t)) ? (this._latlng = z(t), S(this, e)) : (S(this, t), this._source = e), this.options.content && (this._content = this.options.content);
      },
      ...
      onRemove: function(t) {
        t._fadeAnimated ? (Q(this._container, 0), this._removeTimeout = setTimeout(g(B, void 0, this._container), 200)) : B(this._container), this.options.interactive && (R(this._container, "leaflet-interactive"), this.removeInteractiveTarget(this._container));
      },
      ...
      _updatePosition: function() {
        if (this._map) {
          var t = this._map.latLngToLayerPoint(this._latlng), e = y(this.options.offset), i = this._getAnchor();
    ...
    var me = lt.extend({
      ...
      onAdd: function(t) {
        lt.prototype.onAdd.call(this, t), t.fire("popupopen", { popup: this }), this._source && (this._source.fire("popupopen", { popup: this }, !0), this._source instanceof yt || this._source.on("preclick", Lt));
      },
      onRemove: function(t) {
        lt.prototype.onRemove.call(this, t), t.fire("popupclose", { popup: this }), this._source && (this._source.fire("popupclose", { popup: this }, !0), this._source instanceof yt || this._source.off("preclick", Lt));
      },
      getEvents: function() {
      ...
      _initLayout: function() {
        ...
        if (this._contentNode = k("div", t + "-content", i), Gt(e), Ve(this._contentNode), b(e, "contextmenu", Lt), this._tipContainer = k("div", t + "-tip-container", e), this._tip = k("div", t + "-tip", this._tipContainer), this.options.closeButton) {
      ...
      _updateLayout: function() {
        ...
        o && n > o ? (e.height = o + "px", P(t, r)) : R(t, r), this._containerWidth = this._container.offsetWidth;
      },
      _animateZoom: function(t) {
      ...
      _adjustPan: function() {
        if (this.options.autoPan) {
          ...
          var t = this._map, e = parseInt(Wt(this._container, "marginBottom"), 10) || 0, i = this._container.offsetHeight + e, n = this._containerWidth, o = new w(this._containerLeft, -i - this._containerBottom);
          o._add(Pt(this._container));
          var r = t.layerPointToContainerPoint(o), s = y(this.options.autoPanPadding), h = y(this.options.autoPanPaddingTopLeft || s), l = y(this.options.autoPanPaddingBottomRight || s), u = t.getSize(), _ = 0, v = 0;
          r.x + n + l.x > u.x && (_ = r.x + n - u.x + l.x), r.x - _ - h.x < 0 && (_ = r.x - h.x), r.y + i + l.y > u.y && (v = r.y + i - u.y + l.y), r.y - v - h.y < 0 && (v = r.y - h.y), (_ || v) && (this.options.keepInView && (this._autopanning = !0), t.fire("autopanstart").panBy([_, v]));
        }
      },
      _getAnchor: function() {
    ...
    C.mergeOptions({
      ...
      bindPopup: function(t, e) {
        return this._popup = this._initOverlay(me, this._popup, t, e), this._popupHandlersAdded || (this.on({
      ...
      openPopup: function(t) {
        return this._popup && (this instanceof dt || (this._popup._source = this), this._popup._prepareOpen(t || this._latlng) && this._popup.openOn(this._map)), this;
      },
    ...
    var ge = lt.extend({
      ...
      _initLayout: function() {
        ...
        this._contentNode = this._container = k("div", e), this._container.setAttribute("role", "tooltip"), this._container.setAttribute("id", "leaflet-tooltip-" + x(this));
      },
      _updateLayout: function() {
      },
      _adjustPan: function() {
      ...
      _setPosition: function(t) {
        var e, i, n = this._map, o = this._container, r = n.latLngToContainerPoint(n.getCenter()), s = n.layerPointToContainerPoint(t), h = this.options.direction, l = o.offsetWidth, u = o.offsetHeight, _ = y(this.options.offset), v = this._getAnchor();
        h === "top" ? (e = l / 2, i = u) : h === "bottom" ? (e = l / 2, i = 0) : h === "center" ? (e = l / 2, i = u / 2) : h === "right" ? (e = 0, i = u / 2) : h === "left" ? (e = l, i = u / 2) : s.x < r.x ? (h = "right", e = 0, i = u / 2) : (h = "left", e = l + (_.x + v.x) * 2, i = u / 2), t = t.subtract(y(e, i, !0)).add(_).add(v), R(o, "leaflet-tooltip-right"), R(o, "leaflet-tooltip-left"), R(o, "leaflet-tooltip-top"), R(o, "leaflet-tooltip-bottom"), P(o, "leaflet-tooltip-" + h), D(o, t);
      },
      _updatePosition: function() {
    ...
    C.include({
      ...
      openTooltip: function(t) {
        return this._tooltip && (this instanceof dt || (this._tooltip._source = this), this._tooltip._prepareOpen(t) && (this._tooltip.openOn(this._map), this.getElement ? this._setAriaDescribedByOnLayer(this) : this.eachLayer && this.eachLayer(this._setAriaDescribedByOnLayer, this))), this;
      },
    ...
    var Yt = rt.extend({
        ...
        if (this._map && !m.ielt9) {
          ...
          for (var n in this._tiles) {
            ...
            if (!(!o.current || !o.loaded)) {
              ...
              Q(o.el, r), r < 1 ? e = !0 : (o.active ? i = !0 : this._onOpaqueTile(o), o.active = !0);
            }
          }
      ...
      _updateLevels: function() {
        ...
        if (t !== void 0) {
          ...
          return n || (n = this._levels[t] = {}, n.el = k("div", "leaflet-tile-container leaflet-zoom-animated", this._container), n.el.style.zIndex = e, n.origin = o.project(o.unproject(o.getPixelOrigin()), t).round(), n.zoom = t, this._setZoomTransform(n, o.getCenter(), o.getZoom()), Z(n.el.offsetWidth), this._onCreateLevel(n)), this._level = n, n;
        }
      },
      _onUpdateLevel: Z,
      _onRemoveLevel: Z,
      ...
      _retainParent: function(t, e, i, n) {
        var o = Math.floor(t / 2), r = Math.floor(e / 2), s = i - 1, h = new w(+o, +r);
        h.z = +s;
        var l = this._tileCoordsToKey(h), u = this._tiles[l];
        return u && u.active ? (u.retain = !0, !0) : (u && u.loaded && (u.retain = !0), s > n ? this._retainParent(o, r, s, n) : !1);
      },
      _retainChildren: function(t, e, i, n) {
        for (var o = 2 * t; o < 2 * t + 2; o++)
          for (var r = 2 * e; r < 2 * e + 2; r++) {
            var s = new w(o, r);
            s.z = i + 1;
            var h = this._tileCoordsToKey(s), l = this._tiles[h];
            if (l && l.active) {
              l.retain = !0;
              continue;
      ...
      _update: function(t) {
        ...
        if (e) {
          ...
          if (t === void 0 && (t = e.getCenter()), this._tileZoom !== void 0) {
            var n = this._getTiledPixelBounds(t), o = this._pxBoundsToTileRange(n), r = o.getCenter(), s = [], h = this.options.keepBuffer, l = new I(
            ...
            for (var u in this._tiles) {
              var _ = this._tiles[u].coords;
              (_.z !== this._tileZoom || !l.contains(new w(_.x, _.y))) && (this._tiles[u].current = !1);
            }
            ...
            for (var v = o.min.y; v <= o.max.y; v++)
              for (var T = o.min.x; T <= o.max.x; T++) {
                ...
                if (q.z = this._tileZoom, !!this._isValidTile(q)) {
                  var F = this._tiles[this._tileCoordsToKey(q)];
                  F ? F.current = !0 : s.push(q);
                }
              }
            if (s.sort(function(K, It) {
              return K.distanceTo(r) - It.distanceTo(r);
            }), s.length !== 0) {
              this._loading || (this._loading = !0, this.fire("loading"));
              var tt = document.createDocumentFragment();
              for (T = 0; T < s.length; T++)
                this._addTile(s[T], tt);
      ...
      _initTile: function(t) {
        ...
        t.style.width = e.x + "px", t.style.height = e.y + "px", t.onselectstart = Z, t.onmousemove = Z, m.ielt9 && this.options.opacity < 1 && Q(t, this.options.opacity);
      },
      _addTile: function(t, e) {
        var i = this._getTilePos(t), n = this._tileCoordsToKey(t), o = this.createTile(this._wrapCoords(t), g(this._tileReady, this, t));
        this._initTile(o), this.createTile.length < 2 && G(g(this._tileReady, this, t, null, o)), D(o, i), this._tiles[n] = {
          el: o,
          coords: t,
          current: !0
      ...
      _tileReady: function(t, e, i) {
        ...
        i = this._tiles[n], i && (i.loaded = +/* @__PURE__ */ new Date(), this._map._fadeAnimated ? (Q(i.el, 0), X(this._fadeFrame), this._fadeFrame = G(this._updateOpacity, this)) : (i.active = !0, this._pruneTiles()), e || (P(i.el, "leaflet-tile-loaded"), this.fire("tileload", {
          tile: i.el,
          coords: t
        })), this._noTilesToLoad() && (this._loading = !1, this.fire("load"), m.ielt9 || !this._map._fadeAnimated ? G(this._pruneTiles, this) : setTimeout(g(this._pruneTiles, this), 250)));
      },
      ...
      _wrapCoords: function(t) {
        var e = new w(
          this._wrapX ? xt(t.x, this._wrapX) : t.x,
          this._wrapY ? xt(t.y, this._wrapY) : t.y
        );
        return e.z = t.z, e;
      },
    ...
    var Zt = Yt.extend({
      ...
      createTile: function(t, e) {
        ...
        return b(i, "load", g(this._tileOnLoad, this, e, i)), b(i, "error", g(this._tileOnError, this, e, i)), (this.options.crossOrigin || this.options.crossOrigin === "") && (i.crossOrigin = this.options.crossOrigin === !0 ? "" : this.options.crossOrigin), typeof this.options.referrerPolicy == "string" && (i.referrerPolicy = this.options.referrerPolicy), i.alt = "", i.src = this.getTileUrl(t), i;
      },
      // @section Extension methods
      // @uninheritable
      ...
      getTileUrl: function(t) {
        ...
        return wt(this._url, d(e, this.options));
      },
      _tileOnLoad: function(t, e) {
        m.ielt9 ? setTimeout(g(t, this, null, e), 0) : t(null, e);
      },
      ...
      _removeTile: function(t) {
        var e = this._tiles[t];
        if (e)
          return e.el.setAttribute("src", te), Yt.prototype._removeTile.call(this, t);
      },
      _tileReady: function(t, e, i) {
    ...
    var un = Zt.extend({
      ...
      initialize: function(t, e) {
        ...
        e = S(this, e);
        var o = e.detectRetina && m.retina ? 2 : 1, r = this.getTileSize();
      ...
      getTileUrl: function(t) {
        var e = this._tileCoordsToNwSe(t), i = this._crs, n = V(i.project(e[0]), i.project(e[1])), o = n.min, r = n.max, s = (this._wmsVersion >= 1.3 && this._crs === en ? [o.y, o.x, r.y, r.x] : [o.x, o.y, r.x, r.y]).join(","), h = Zt.prototype.getTileUrl.call(this, t);
        return h + Qt(this.wmsParams, h, this.options.uppercase) + (this.options.uppercase ? "&BBOX=" : "&bbox=") + s;
      },
    ...
    var mt = rt.extend({
      ...
      _updateTransform: function(t, e) {
        ...
        m.any3d ? bt(this._container, r, i) : D(this._container, r);
      },
      _reset: function() {
      ...
      _update: function() {
        ...
        this._bounds = new I(i, i.add(e.multiplyBy(1 + t * 2)).round()), this._center = this._map.getCenter(), this._zoom = this._map.getZoom();
      }
    }), cn = mt.extend({
      // @section
      // @aka Canvas options
      ...
      _destroyContainer: function() {
        X(this._redrawRequest), delete this._ctx, B(this._container), O(this._container), delete this._container;
      },
      _updatePaths: function() {
      ...
      _update: function() {
        if (!(this._map._animatingZoom && this._bounds)) {
          ...
          D(e, t.min), e.width = n * i.x, e.height = n * i.y, e.style.width = i.x + "px", e.style.height = i.y + "px", m.retina && this._ctx.scale(2, 2), this._ctx.translate(-t.min.x, -t.min.y), this.fire("update");
        }
      },
      _reset: function() {
      ...
      _updatePoly: function(t, e) {
        if (this._drawing) {
          var i, n, o, r, s = t._parts, h = s.length, l = this._ctx;
          if (h) {
            for (l.beginPath(), i = 0; i < h; i++) {
      ...
      _handleMouseHover: function(t, e) {
        if (!this._mouseHoverThrottled) {
          ...
          n !== this._hoveredLayer && (this._handleMouseOut(t), n && (P(this._container, "leaflet-interactive"), this._fireEvent([n], t, "mouseover"), this._hoveredLayer = n)), this._fireEvent(this._hoveredLayer ? [this._hoveredLayer] : !1, t), this._mouseHoverThrottled = !0, setTimeout(g(function() {
    ...
    var Jt = function() {
      ...
      _initPath: function(t) {
        ...
        P(e, "leaflet-vml-shape " + (this.options.className || "")), e.coordsize = "1 1", t._path = Jt("path"), e.appendChild(t._path), this._updateStyle(t), this._layers[x(t)] = t;
      },
      _addPath: function(t) {
        var e = t._container;
      ...
      _removePath: function(t) {
        var e = t._container;
        B(e), t.removeInteractiveTarget(e), delete this._layers[x(t)];
      },
      _updateStyle: function(t) {
      ...
      _destroyContainer: function() {
        B(this._container), O(this._container), delete this._container, delete this._rootGroup, delete this._svgSize;
      },
      _update: function() {
        if (!(this._map._animatingZoom && this._bounds)) {
          mt.prototype._update.call(this);
      ...
      _initPath: function(t) {
        ...
        t.options.className && P(e, t.options.className), t.options.interactive && P(e, "leaflet-interactive"), this._updateStyle(t), this._layers[x(t)] = t;
      },
      _addPath: function(t) {
        this._rootGroup || this._initContainer(), this._rootGroup.appendChild(t._path), t.addInteractiveTarget(t._path);
      },
      _removePath: function(t) {
        B(t._path), t.removeInteractiveTarget(t._path), delete this._layers[x(t)];
      },
      _updatePath: function(t) {
    ...
    m.vml && Xt.include(Vo);
    function dn(t) {
      return m.svg || m.vml ? new Xt(t) : null;
    }
    C.include({
      ...
      _createRenderer: function(t) {
        return this.options.preferCanvas && fn(t) || dn(t);
      }
    });
    var _n = St.extend({
      initialize: function(t, e) {
        St.prototype.initialize.call(this, this._boundsToLatLngs(t), e);
      },
    ...
    Xt.create = ve, Xt.pointsToPath = mi, pt.geometryToLayer = ce, pt.coordsToLatLng = ei, pt.coordsToLatLngs = fe, pt.latLngToCoords = ii, pt.latLngsToCoords = de, pt.getFeature = Ot, pt.asFeature = _e, C.mergeOptions({
    ...
    var pn = ht.extend({
      ...
      _onMouseDown: function(t) {
        if (!t.shiftKey || t.which !== 1 && t.button !== 1)
          return !1;
        this._clearDeferredResetState(), this._resetState(), Ft(), Ne(), this._startPoint = this._map.mouseEventToContainerPoint(t), b(document, {
          contextmenu: Tt,
      ...
      _onMouseMove: function(t) {
        this._moved || (this._moved = !0, this._box = k("div", "leaflet-zoom-box", this._container), P(this._container, "leaflet-crosshair"), this._map.fire("boxzoomstart")), this._point = this._map.mouseEventToContainerPoint(t);
      ...
      _finish: function() {
        this._moved && (B(this._box), R(this._container, "leaflet-crosshair")), Ut(), De(), O(document, {
          contextmenu: Tt,
          mousemove: this._onMouseMove,
          mouseup: this._onMouseUp,
          keydown: this._onKeyDown
    ...
    C.addInitHook("addHandler", "boxZoom", pn), C.mergeOptions({
    ...
    C.addInitHook("addHandler", "doubleClickZoom", mn), C.mergeOptions({
    ...
    var gn = ht.extend({
      ...
      _onDragEnd: function(t) {
        ...
        if (e.fire("dragend", t), n)
          ...
          var o = this._lastPos.subtract(this._positions[0]), r = (this._lastTime - this._times[0]) / 1e3, s = i.easeLinearity, h = o.multiplyBy(s / r), l = h.distanceTo([0, 0]), u = Math.min(i.inertiaMaxSpeed, l), _ = h.multiplyBy(u / l), v = u / (i.inertiaDeceleration * s), T = _.multiplyBy(-v / 2).round();
          !T.x && !T.y ? e.fire("moveend") : (T = e._limitOffset(T, e.options.maxBounds), G(function() {
            e.panBy(T, {
              duration: v,
              easeLinearity: s,
              noMoveStart: !0,
    ...
    C.addInitHook("addHandler", "dragging", gn), C.mergeOptions({
      // @option keyboard: Boolean = true
        ...
        if (!(t.altKey || t.ctrlKey || t.metaKey)) {
          ...
          if (e in this._panKeys) {
            if (!i._panAnim || !i._panAnim._inProgress)
              if (n = this._panKeys[e], t.shiftKey && (n = y(n).multiplyBy(3)), i.options.maxBounds && (n = i._limitOffset(y(n), i.options.maxBounds)), i.options.worldCopyJump) {
    ...
    C.addInitHook("addHandler", "keyboard", vn), C.mergeOptions({
    ...
    var yn = ht.extend({
      ...
      _onWheelScroll: function(t) {
        var e = Fi(t), i = this._map.options.wheelDebounceTime;
        this._delta += e, this._lastMousePos = this._map.mouseEventToContainerPoint(t), this._startTime || (this._startTime = +/* @__PURE__ */ new Date());
        var n = Math.max(i - (+/* @__PURE__ */ new Date() - this._startTime), 0);
        clearTimeout(this._timer), this._timer = setTimeout(g(this._performZoom, this), n), Tt(t);
      },
    ...
    C.addInitHook("addHandler", "scrollWheelZoom", yn);
    var Ko = 600;
    C.mergeOptions({
    ...
    var xn = ht.extend({
      ...
      _onDown: function(t) {
        if (clearTimeout(this._holdTimeout), t.touches.length === 1) {
          ...
          this._startPos = this._newPos = new w(e.clientX, e.clientY), this._holdTimeout = setTimeout(g(function() {
            this._cancel(), this._isTapValid() && (b(document, "touchend", U), b(document, "touchend touchcancel", this._cancelClickPrevent), this._simulateEvent("contextmenu", e));
          }, this), Ko), b(document, "touchend touchcancel contextmenu", this._cancel, this), b(document, "touchmove", this._onMove, this);
        }
      },
      _cancelClickPrevent: function t() {
        O(document, "touchend", U), O(document, "touchend touchcancel", t);
      },
      _cancel: function() {
      ...
      _onMove: function(t) {
        var e = t.touches[0];
        this._newPos = new w(e.clientX, e.clientY);
      },
    ...
    C.addInitHook("addHandler", "tapHold", xn), C.mergeOptions({
      // @section Touch interaction options
    ...
    var wn = ht.extend({
      addHooks: function() {
        P(this._map._container, "leaflet-touch-zoom"), b(this._map._container, "touchstart", this._onTouchStart, this);
      },
      removeHooks: function() {
        R(this._map._container, "leaflet-touch-zoom"), O(this._map._container, "touchstart", this._onTouchStart, this);
      },
      _onTouchStart: function(t) {
        var e = this._map;
        if (!(!t.touches || t.touches.length !== 2 || e._animatingZoom || this._zooming)) {
          var i = e.mouseEventToContainerPoint(t.touches[0]), n = e.mouseEventToContainerPoint(t.touches[1]);
          this._centerPoint = e.getSize()._divideBy(2), this._startLatLng = e.containerPointToLatLng(this._centerPoint), e.options.touchZoom !== "center" && (this._pinchStartLatLng = e.containerPointToLatLng(i.add(n)._divideBy(2))), this._startDist = i.distanceTo(n), this._startZoom = e.getZoom(), this._moved = !1, this._zooming = !0, e._stop(), b(document, "touchmove", this._onTouchMove, this), b(document, "touchend touchcancel", this._onTouchEnd, this), U(t);
        }
      },
      _onTouchMove: function(t) {
        if (!(!t.touches || t.touches.length !== 2 || !this._zooming)) {
          ...
          var s = g(e._move, e, this._center, this._zoom, { pinch: !0, round: !1 }, void 0);
      ...
      _onTouchEnd: function() {
        ...
        this._zooming = !1, X(this._animRequest), O(document, "touchmove", this._onTouchMove, this), O(document, "touchend touchcancel", this._onTouchEnd, this), this._map.options.zoomAnimation ? this._map._animateZoom(this._center, this._map._limitZoom(this._zoom), !0, this._map.options.zoomSnap) : this._map._resetView(this._center, this._map._limitZoom(this._zoom));
      }
    });
    C.addInitHook("addHandler", "touchZoom", wn), C.BoxZoom = pn, C.DoubleClickZoom = mn, C.Drag = gn, C.Keyboard = vn, C.ScrollWheelZoom = yn, C.TapHold = xn, C.TouchZoom = wn, a.Bounds = I, a.Browser = m, a.CRS = ft, a.Canvas = cn, a.Circle = ti, a.CircleMarker = ue, a.Class = ct, a.Control = ot, a.DivIcon = hn, a.DivOverlay = lt, a.DomEvent = co, a.DomUtil = lo, a.Draggable = vt, a.Evented = Rt, a.FeatureGroup = dt, a.GeoJSON = pt, a.GridLayer = Yt, a.Handler = ht, a.Icon = Et, a.ImageOverlay = pe, a.LatLng = E, a.LatLngBounds = j, a.Layer = rt, a.LayerGroup = At, a.LineUtil = To, a.Map = C, a.Marker = le, a.Mixin = yo, a.Path = yt, a.Point = w, a.PolyUtil = xo, a.Polygon = St, a.Polyline = _t, a.Popup = me, a.PosAnimation = Ui, a.Projection = zo, a.Rectangle = _n, a.Renderer = mt, a.SVG = Xt, a.SVGOverlay = an, a.TileLayer = Zt, a.Tooltip = ge, a.Transformation = ze, a.Util = En, a.VideoOverlay = sn, a.bind = g, a.bounds = V, a.canvas = fn, a.circle = Zo, a.circleMarker = Oo, a.control = Vt, a.divIcon = Uo, a.extend = d, a.featureGroup = Ao, a.geoJSON = rn, a.geoJson = Ro, a.gridLayer = qo, a.icon = Eo, a.imageOverlay = No, a.latLng = z, a.latLngBounds = N, a.layerGroup = ko, a.map = fo, a.marker = So, a.point = y, a.polygon = Bo, a.polyline = Io, a.popup = Wo, a.rectangle = jo, a.setOptions = S, a.stamp = x, a.svg = dn, a.svgOverlay = Ho, a.tileLayer = ln, a.tooltip = Fo, a.transformation = Nt, a.version = f, a.videoOverlay = Do;
    var Yo = window.L;
    a.noConflict = function() {
      return window.L = Yo, this;
    }, window.L = a;
  });
})(si, si.exports);
var Bt = si.exports;
const br = /* @__PURE__ */ rr(Bt);
function xe(p, c, a) {
  return Object.freeze({
    instance: p,
    context: c,
...
function we(p, c) {
  return c == null ? function(f, d) {
    const M = A.useRef();
    return M.current || (M.current = p(f, d)), M;
  } : function(f, d) {
    const M = A.useRef();
    M.current || (M.current = p(f, d));
    const g = A.useRef(f), { instance: W } = M.current;
    return A.useEffect(function() {
      g.current !== f && (c(W, f, g.current), g.current = f);
    }, [
      W,
      f,
      d
...
function _r(p, c) {
  A.useEffect(function() {
    return (c.layerContainer ?? c.map).addLayer(p.instance), function() {
      c.layerContainer?.removeLayer(p.instance), c.map.removeLayer(p.instance);
    };
  }, [
    c,
    p
...
function An(p) {
  return function(a) {
    const f = hi(), d = p(li(a, f), f);
    return Tn(f.map, a.attribution), kn(d.current, a.eventHandlers), _r(d.current, f), d;
  };
}
function pr(p) {
  function c(d, M) {
...
function mr(p, c) {
  const a = we(p, c), f = An(a);
  return ur(f);
}
function gr(p, c) {
  const a = we(p), f = dr(a, c);
  return cr(f);
}
function vr(p, c) {
  const a = we(p, c), f = An(a);
...
function yr(p, c, a) {
  const { opacity: f, zIndex: d } = c;
  f != null && f !== a.opacity && p.setOpacity(f), d != null && d !== a.zIndex && p.setZIndex(d);
}
function ai() {
  return ai = Object.assign || function(p) {
    for (var c = 1; c < arguments.length; c++) {
      var a = arguments[c];
      for (var f in a)
        Object.prototype.hasOwnProperty.call(a, f) && (p[f] = a[f]);
    }
    return p;
  }, ai.apply(this, arguments);
}
function xr({ bounds: p, boundsOptions: c, center: a, children: f, className: d, id: M, placeholder: g, style: W, whenReady: x, zoom: et, ...xt }, Z) {
  const [J] = A.useState({
    className: d,
    id: M,
    style: W
  }), [it, ut] = A.useState(null);
  A.useImperativeHandle(Z, () => it?.map ?? null, [
    it
  ]);
  const S = A.useCallback(($t) => {
    if ($t !== null && it === null) {
      const wt = new Bt.Map($t, xt);
      a != null && et != null ? wt.setView(a, et) : p != null && wt.fitBounds(p, c), x != null && wt.whenReady(x), ut(hr(wt));
    }
  }, []);
  A.useEffect(() => () => {
    it?.map.remove();
  ...
  const Qt = it ? /* @__PURE__ */ ri.createElement(Cn, {
    value: it
  }, f) : g ?? null;
  return /* @__PURE__ */ ri.createElement("div", ai({}, J, {
    ref: S
  }), Qt);
}
const Pr = /* @__PURE__ */ A.forwardRef(xr), Lr = mr(function({ position: c, ...a }, f) {
  const d = new Bt.Marker(c, a);
  return xe(d, lr(f, {
    overlayContainer: d
  }));
}, function(c, a, f) {
  ...
  const f = new Bt.Popup(c, a.overlayContainer);
  return xe(f, a);
}, function(c, a, { position: f }, d) {
  A.useEffect(function() {
    const { instance: g } = c;
    function W(et) {
      et.popup === g && (g.update(), d(!0));
    }
    function x(et) {
      et.popup === g && d(!1);
    }
    return a.map.on({
      popupopen: W,
      popupclose: x
    }), a.overlayContainer == null ? (f != null && g.setLatLng(f), g.openOn(a.map)) : a.overlayContainer.bindPopup(g), function() {
      a.map.off({
        popupopen: W,
        popupclose: x
      }), a.overlayContainer?.unbindPopup(), a.map.removeLayer(g);
    };
  }, [
    c,
    a,
